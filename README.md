...
| [cyber-log-clustering](https://github.com/loicguillois/cyber-log-clustering) | ML-based threat detection from network logs | Python, Scikit-learn | AI / Cybersecurity |
